...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("F:\\JavaProjects\\guli-parent\\service\\service_statistics" + "/src/main/java");
        gc.setAuthor("Leo");
        ...
        dsc.setUrl("jdbc:mysql://192.168.174.128:3306/guli_edu");
        ...
        strategy.setInclude("statistics_daily");//根据数据库中表的结构逆向生成代码
